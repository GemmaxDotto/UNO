                ...
                while (true) {
                    ...
                    if(receivedMessage != null &&receivedMessage.strip().split(";")[0].equals("speciale")){
                        ...
                        switch (receivedMessage.strip().split(";")[2]) {
                            case "salta_turno":
                                System.out.println("giocatore"+receivedMessage.strip().split(";")[1]+" salta un turno");
                                break;
                            case "pesca_due":
                                System.out.println("giocatore"+receivedMessage.strip().split(";")[1]+" pesca due carte");

                                break;
                            case "pesca_quattro":
                                System.out.println("giocatore"+receivedMessage.strip().split(";")[1]+" pesca quattro carte");
                                break;
                        
                        }
                    }
                    
                    String nickClient=receivedMessage.strip().split(";")[0];
                    
                    

                    if(receivedMessage != null &&receivedMessage.strip().split(";")[1].equals("pesca")&& cond.Game.nickNameString.equals(nickClient)){
                    ...
                    if(receivedMessage != null &&receivedMessage.strip().split(";")[1].equals("CentralChangeCard") && cond.Game.nickNameString.equals(nickClient)){
                        cond.Game.gestisciRispostaCambia(receivedMessage.strip().split(";")[1]);
                        System.out.println("cambia centrale");
                    }
                    if(receivedMessage != null &&receivedMessage.strip().split(";")[1].equals("errore") && cond.Game.nickNameString.equals(nickClient)){
                    ...
                    if(receivedMessage != null &&receivedMessage.strip().split(";")[1].equals("carte_pescate") && cond.Game.nickNameString.equals(nickClient)){
